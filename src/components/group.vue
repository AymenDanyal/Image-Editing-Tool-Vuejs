...
<template>
  <div class="attr-item box" v-if="isMultiple || isGroup">
    ...
    <!-- Combination button is not available for multiple selections -->
    ...
    <!-- Split combination button, available when it is a radio selection and group elements -->
...
// Single selection and equal to group element
